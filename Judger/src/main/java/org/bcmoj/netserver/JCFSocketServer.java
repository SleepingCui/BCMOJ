    ...
    private static class ClientHandler implements Runnable {
        ...
        public void run() {
            ...
            try (DataInputStream dis = new DataInputStream(clientSocket.getInputStream());
                ...
                clientLogger.info("[{}] Starting file transfer protocol", clientAddress);
                ...
                clientLogger.info("[{}] Receiving file ({} bytes), saving as: {}",
                        clientAddress, fileSize, newFileName);
                ...
                if (outputFile.exists() && outputFile.getName().endsWith(".cpp")) {
                    if (outputFile.delete()) {
                        clientLogger.info("[{}] Deleted uploaded file: {}", clientAddress, outputFile.getName());
                    } else {
                        clientLogger.warn("[{}] Failed to delete uploaded file: {}", clientAddress, outputFile.getName());
                    }
                }
